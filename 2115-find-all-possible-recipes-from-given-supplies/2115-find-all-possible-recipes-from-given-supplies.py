...
if __name__ == "__main__":
    ...
    print(solution.findAllRecipes(recipes1, ingredients1, supplies1))  # Output: ["bread"]

    recipes2 = ["bread", "sandwich"]
    ingredients2 = [["yeast", "flour"], ["bread", "meat"]]
    supplies2 = ["yeast", "flour", "meat"]
    print(solution.findAllRecipes(recipes2, ingredients2, supplies2))  # Output: ["bread", "sandwich"]
